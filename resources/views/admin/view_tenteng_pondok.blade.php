  ...
  <div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Info Pesantren</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a>Tentang</a></div>
              <div class="breadcrumb-item active"><a>Info Pesantren</a></div>
            </div>
          </div>
  ...
  <script>
    ...
    $('#form_info_pesantren').submit(function(e){
            ...
            data.append('deskripsi', inputcatatan);
                $.ajax({
                    url: "/edit-info-pesantren/simpan",
                    method: "POST",
                    data:  data,
                    processData: false,
                    contentType: false,
